...
import static com.alexrootroatch.httpserver.routes.Form.getQueryParams;
import static com.alexrootroatch.httpserver.routes.Form.queryParamsToHTML;
...
public class HTMLTest {
  ...
  @Test
  void queryParamWithEncodedValue() {
    String[] params = {"name=John%20Doe"};
    String result = queryParamsToHTML(params);
    assertTrue(result.contains("<li>name: John Doe</li>"));
  }
}
